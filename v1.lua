...
local function loadAura(name)
    if Cache.AuraCache[name] then return Cache.AuraCache[name] end    local id = AURA_IDS[name]
...
ESPSection:AddColorPicker({Default = Settings.TracersColor, Flag = "TracersColor", Callback = function(c) Settings.TracersColor = c end})
...
ChamsSection:AddColorPicker({Default = Settings.ChamsColor, Flag = "ChamsColor", Callback = function(c) Settings.ChamsColor = c end})
...
EffectsSection:AddLabel("Jump Circles"):AddToggle({Default = Settings.JumpCircles, Flag = "JumpCircles", Callback = function(v) Settings.JumpCircles = v end})
...
EffectsSection:AddLabel("Trails"):AddToggle({Default = Settings.Trails, Flag = "Trails", Callback = function(v) Settings.Trails = v; if v then createLocalPlayerTrail() else removeLocalPlayerTrail() end end})
EffectsSection:AddColorPicker({Default = Settings.TrailsColor, Flag = "TrailsColor", Callback = function(c) Settings.TrailsColor = c; updateTrailColor() end})
EffectsSection:AddLabel("XRay"):AddToggle({Default = Settings.XRayEnabled, Flag = "XRay", Callback = function(v) Settings.XRayEnabled = v; setupXRay() end})
EffectsSection:AddLabel("Bloom"):AddToggle({Default = Settings.BloomEnabled, Flag = "Bloom", Callback = function(v) Settings.BloomEnabled = v; setupBloom(v) end})
EffectsSection:AddLabel("Vignette"):AddToggle({Default = Settings.VignetteEnabled, Flag = "Vignette", Callback = function(v) Settings.VignetteEnabled = v; setupVignette(v) end})

local ChinaSection = VisualsTab:AddSection({Name = "China Hat", Position = "Right"})
ChinaSection:AddLabel("Enable"):AddToggle({Default = Settings.ChinaHatEnabled, Flag = "ChinaHat", Callback = function(v) toggleChinaHat(v) end})
ChinaSection:AddColorPicker({Default = Settings.ChinaHatColor, Flag = "ChinaHatColor", Callback = function(c) Settings.ChinaHatColor = c end})
ChinaSection:AddLabel("Rainbow"):AddToggle({Default = Settings.ChinaHatRainbow, Flag = "ChinaHatRainbow", Callback = function(v) Settings.ChinaHatRainbow = v end})

local AuraSection = VisualsTab:AddSection({Name = "Aura", Position = "Left"})
AuraSection:AddLabel("Enable"):AddToggle({Default = Settings.AuraEnabled, Flag = "Aura", Callback = function(v) Settings.AuraEnabled = v; if v then applyAura() else clearAura() end end})
...
WorldSection:AddLabel("Orbiz"):AddToggle({Default = Settings.OrbizEnabled, Flag = "Orbiz", Callback = function(v) Settings.OrbizEnabled = v; createOrbiz() end})
WorldSection:AddLabel("Texture Pack"):AddToggle({Default = Settings.TexturePackEnabled, Flag = "TexturePack", Callback = function(v) Settings.TexturePackEnabled = v; if v then applyTexturePack() else clearTexturePack() end end})
WorldSection:AddLabel("Stretch"):AddToggle({Default = Settings.StretchEnabled, Flag = "Stretch", Callback = function(v) Settings.StretchEnabled = v; applyStretch(v) end})
...
CombatSection:AddLabel("Shoot Button"):AddToggle({Default = Settings.ShootButtonEnabled, Flag = "ShootButton", Callback = function(v) Settings.ShootButtonEnabled = v; if v then createShootButton() else if Cache.ShootButton then pcall(function() Cache.ShootButton:Destroy() end); Cache.ShootButton = nil end end})
CombatSection:AddLabel("Sheriff Auto"):AddToggle({Default = Settings.SheriffAutoShootEnabled, Flag = "SheriffAutoShoot", Callback = function(v) Settings.SheriffAutoShootEnabled = v; safeDisconnect(Cache.SheriffAutoShootConnection); Cache.SheriffAutoShootConnection = nil; if v then Cache.SheriffAutoShootConnection = task.spawn(sheriffAutoShootLoop) end end})
CombatSection:AddLabel("Kill All"):AddToggle({Default = Settings.KillAllEnabled, Flag = "KillAll", Callback = function(v) Settings.KillAllEnabled = v; if v then if not Cache.KillAllRemote then FindKillRemote() end; setupKillAll() else safeDisconnect(Cache.KillAllConn); end end})
CombatSection:AddLabel("Fling Murderer"):AddToggle({Default = Settings.FlingMurderer, Flag = "FlingMurderer", Callback = function(v) Settings.FlingMurderer = v; if v then local m = getMurdererFling(); if m then flingPlayer(m) else notify("Флинг", "Убийца не найден!", 2); Settings.FlingMurderer = false end end end})
CombatSection:AddLabel("Fling Sheriff"):AddToggle({Default = Settings.FlingSheriff, Flag = "FlingSheriff", Callback = function(v) Settings.FlingSheriff = v; if v then local s = getSheriffFling(); if s then flingPlayer(s) else notify("Флинг", "Шериф не найден!", 2); Settings.FlingSheriff = false end end end})
CombatSection:AddLabel("Grab Gun"):AddToggle({Default = Settings.GrabGunEnabled, Flag = "GrabGun", Callback = function(v) Settings.GrabGunEnabled = v; if v then grabGunImproved() end end})

local AimbotSection = CombatTab:AddSection({Name = "Aimbot", Position = "Right"})
AimbotSection:AddLabel("FOV Aimbot"):AddToggle({Default = Settings.FovAimbotEnabled, Flag = "FovAimbot", Callback = function(v) Settings.FovAimbotEnabled = v; if v then createFovCircle() end; setupFovAimbot() end})
AimbotSection:AddSlider({Default = 120, Min = 10, Max = 600, Flag = "FovRadius", Callback = function(v) Settings.FovRadius = v; if Cache.FovCircle then Cache.FovCircle.Radius = Settings.FovRadius end end})
AimbotSection:AddSlider({Default = 50, Min = 1, Max = 100, Flag = "AimSmoothness", Callback = function(v) Settings.AimSmoothness = v / 100 end})
AimbotSection:AddLabel("Predict"):AddToggle({Default = Settings.AimPredict, Flag = "AimPredict", Callback = function(v) Settings.AimPredict = v end})
AimbotSection:AddLabel("Wall Check"):AddToggle({Default = Settings.AimWallCheck, Flag = "AimWallCheck", Callback = function(v) Settings.AimWallCheck = v end})
...
MovementSection:AddLabel("Fly"):AddToggle({Default = Settings.FlyEnabled, Flag = "Fly", Callback = function(v) Settings.FlyEnabled = v; if v then startFly() else stopFly() end end})
MovementSection:AddSlider({Default = 50, Min = 10, Max = 200, Flag = "FlySpeed", Callback = function(v) Settings.FlySpeed = v end})
MovementSection:AddLabel("BHop"):AddToggle({Default = Settings.BHopEnabled, Flag = "BHop", Callback = function(v) Settings.BHopEnabled = v; if v then startBHop() else stopBHop() end end})
MovementSection:AddSlider({Default = 30, Min = 10, Max = 80, Flag = "BHopSpeed", Callback = function(v) Settings.BHopSpeed = v end})
MovementSection:AddLabel("Spin Bot"):AddToggle({Default = Settings.SpinBotEnabled, Flag = "SpinBot", Callback = function(v) Settings.SpinBotEnabled = v; toggleSpinBot(v) end})
MovementSection:AddSlider({Default = 9999, Min = 100, Max = 20000, Flag = "SpinSpeed", Callback = function(v) SpinBot.Speed = v end})
MovementSection:AddLabel("Noclip"):AddToggle({Default = Settings.NoclipEnabled, Flag = "Noclip", Callback = function(v) Settings.NoclipEnabled = v; setupNoclip(v) end})
MovementSection:AddLabel("Anti-Fling"):AddToggle({Default = Settings.AntiFlingEnabled, Flag = "AntiFling", Callback = function(v) Settings.AntiFlingEnabled = v; setupAntiFling() end})
MovementSection:AddLabel("Wall Hop"):AddToggle({Default = Settings.WallHopEnabled, Flag = "WallHop", Callback = function(v) toggleWallHop(v) end})

-- 4. FARM TAB
local FarmTab = Window:AddTab({Name = "Farm", Icon = "tractor"})

local FarmSection = FarmTab:AddSection({Name = "Auto Farm", Position = "Left"})
FarmSection:AddLabel("Enable"):AddToggle({Default = Settings.AutoFarmEnabled, Flag = "AutoFarm", Callback = function(v) Settings.AutoFarmEnabled = v; setupAutoFarm() end})
FarmSection:AddLabel("Auto Respawn"):AddToggle({Default = Settings.AutoRespawn, Flag = "AutoRespawn", Callback = function(v) Settings.AutoRespawn = v end})
...
AnimSection:AddLabel("Enable"):AddToggle({Default = Settings.AnimPackEnabled, Flag = "AnimPackEnabled", Callback = function(v) Settings.AnimPackEnabled = v; if v and Settings.AnimPack ~= "" then applyAnimPack(Settings.AnimPack) end end})
...
FunSection:AddLabel("Jerk"):AddToggle({Default = Settings.JerkEnabled, Flag = "Jerk", Callback = function(v) toggleJerk(v) end})
FunSection:AddLabel("Anti-AFK"):AddToggle({Default = Settings.AntiAFKEnabled, Flag = "AntiAFK", Callback = function(v) Settings.AntiAFKEnabled = v; setupAntiAFK() end})
